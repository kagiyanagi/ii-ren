...
RippleButton {
    ...
    // Icon and label share one colour so a button on a non-secondary
    // container can recolour both at once. The default is what every caller
    // got when it was hardcoded.
