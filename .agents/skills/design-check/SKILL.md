...
name: design-check
description: >-
  Review changed QML in the ii-ren shell against the Android 16 / Material 3
  Expressive design law in .github/DESIGN.md. Use this before calling any UI
  change done, or when the user asks for a design check, design review, or
  whether a widget is on-spec. Reports findings only; does not fix them.
---
...
The scope the user gave decides what to look at:
